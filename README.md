...
## Notes
- After changes, publish a **`v2`** release and pin consumers to `@v2`.
- JS repo requirements: `lint:check`, `typecheck`, `test` scripts (with Biome, `lint:check` can be `biome ci .`).
